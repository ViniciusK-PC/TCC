            ...
            <table className="table text-center">
              <thead>
                <tr>
                  ...
                  <th className="text-accent-content">Status do estoque</th>
